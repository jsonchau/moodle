...
class assign {
    ...
    public function reveal_identities() {
        ...
        if ($this->get_instance()->revealidentites || empty($this->get_instance()->blindmarking)) {
            return false;
        }
    ...
    public function save_grade($userid, $data) {
        ...
        if ($this->get_instance()->teamsubmission && $data->applytoall) {
            $groupid = 0;
