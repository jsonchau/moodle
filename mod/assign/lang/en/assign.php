...
$string['allowsubmissionsfromdate_adminhelp'] = 'If set, the default for the "Allow submissions from" setting will be midnight on the current day + this duration.';
...
$string['defaultsettings_help'] = 'The values you set here define the default values that are used in the settings form when you create a new assignment. You can also configure which assignment settings are considered advanced or cannot be changed by teachers.';
